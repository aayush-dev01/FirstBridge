...
export default function DonorDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Welcome, {profile?.name ?? 'Donor'}</Text>
      <Text style={s.sub}>Donor Dashboard</Text>
      <Text style={s.coming}>Support and impact tracking — coming soon</Text>
