...
export default function StudentDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Welcome, {profile?.name ?? 'Student'}</Text>
      <Text style={s.sub}>Student Dashboard</Text>
      <Text style={s.coming}>Your scholarship journey starts here — coming soon</Text>
