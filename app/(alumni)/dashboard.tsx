...
export default function AlumniDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Welcome, {profile?.name ?? 'Alumnus'}</Text>
      <Text style={s.sub}>Alumni Dashboard</Text>
      <Text style={s.coming}>Give back and stay connected — coming soon</Text>
