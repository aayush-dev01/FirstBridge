...
export default function ParentDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Welcome, {profile?.name ?? 'Parent'}</Text>
      <Text style={s.sub}>Parent / Guardian Dashboard</Text>
      <Text style={s.coming}>Follow your scholar's journey — coming soon</Text>
