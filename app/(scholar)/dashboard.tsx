...
export default function ScholarDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Welcome, {profile?.name ?? 'Scholar'}</Text>
      <Text style={s.sub}>Scholar Dashboard</Text>
      <Text style={s.coming}>Track your scholarship progress — coming soon</Text>
