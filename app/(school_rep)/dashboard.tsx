...
export default function SchoolRepDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Welcome, {profile?.name ?? 'Rep'}</Text>
      <Text style={s.sub}>School Representative Dashboard</Text>
      <Text style={s.coming}>Manage student referrals — coming soon</Text>
